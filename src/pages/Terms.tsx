...
const sections = [
  { title: "1. Objet", content: "Les présentes conditions générales régissent l'utilisation de la plateforme de paris sportifs en ligne Partouche RDC, exploitée sous licence délivrée par les autorités compétentes de la République Démocratique du Congo." },
  ...
  { title: "6. Jeu responsable", content: "Partouche RDC s'engage à promouvoir le jeu responsable. Les joueurs peuvent définir des limites de dépôt (quotidiennes, hebdomadaires, mensuelles), demander une auto-exclusion temporaire ou permanente, et contacter le service d'aide aux joueurs." },
  ...
  { title: "8. Licence", content: "Partouche RDC opère sous la licence N°2024/GJ/001 délivrée par l'autorité de régulation des jeux de la République Démocratique du Congo." },
];
