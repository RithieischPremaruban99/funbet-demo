...
const liveMatches = [
  {
    id: 1,
    league: "DStv Premiership - Matchday 22",
    time: "67'",
    home: { name: "Kaizer Chiefs", abbr: "KC" },
    away: { name: "Orlando Pirates", abbr: "OP" },
    odds: { home: "2.80", draw: "3.10", away: "2.50" },
    score: "1 - 1",
    markets: {
      overUnder: [
        { label: "Over 2.5", odds: "2.20" },
        { label: "Under 2.5", odds: "1.65" },
      ],
      btts: [
        { label: "Both Score - Yes", odds: "1.75" },
        { label: "Both Score - No", odds: "2.00" },
      ],
      doubleChance: [
        { label: "1X", odds: "1.40" },
        { label: "12", odds: "1.35" },
  ...
  },
  {
    ...
    league: "DStv Premiership - Matchday 22",
    time: "52'",
    home: { name: "Mamelodi Sundowns", abbr: "SUN" },
    away: { name: "SuperSport Utd", abbr: "SSU" },
    odds: { home: "1.35", draw: "4.20", away: "7.50" },
    score: "2 - 0",
    markets: {
      overUnder: [
        { label: "Over 2.5", odds: "1.60" },
        { label: "Under 2.5", odds: "2.25" },
      ],
      btts: [
        { label: "Both Score - Yes", odds: "2.10" },
        { label: "Both Score - No", odds: "1.70" },
      ],
      doubleChance: [
        { label: "1X", odds: "1.10" },
        { label: "12", odds: "1.08" },
  ...
  },
  {
    ...
    league: "SA20 Cricket",
    time: "15th Over",
    home: { name: "Joburg Super Kings", abbr: "JSK" },
    away: { name: "Paarl Royals", abbr: "PR" },
    odds: { home: "1.75", draw: "-", away: "2.10" },
    score: "128/3",
    markets: {
      overUnder: [
        { label: "Over 165.5 runs", odds: "1.85" },
        { label: "Under 165.5 runs", odds: "1.95" },
      ],
      btts: [
        { label: "JSK top bat 30+", odds: "1.55" },
        { label: "PR top bat 30+", odds: "1.70" },
      ],
      doubleChance: [
        { label: "JSK by 10+", odds: "3.20" },
        { label: "Close finish", odds: "2.10" },
        { label: "PR by 10+", odds: "4.50" },
      ],
    },
  },
];
...
const upcomingMatches = [
  {
    id: 4,
    league: "DStv Premiership - Matchday 23",
    date: "19:30",
    dateLabel: "TOMORROW",
    home: { name: "Cape Town City", abbr: "CTC" },
    away: { name: "Stellenbosch FC", abbr: "SFC" },
    odds: { home: "2.10", draw: "3.00", away: "3.50" },
    markets: {
      overUnder: [
        { label: "Over 2.5", odds: "2.30" },
        { label: "Under 2.5", odds: "1.60" },
      ],
      btts: [
        { label: "Both Score - Yes", odds: "1.90" },
        { label: "Both Score - No", odds: "1.85" },
      ],
      doubleChance: [
        { label: "1X", odds: "1.30" },
        { label: "12", odds: "1.25" },
  ...
  {
    id: 5,
    league: "Horse Racing - Turffontein",
    date: "14:30",
    dateLabel: "SAT",
    home: { name: "Gold Circle R6", abbr: "GC" },
    away: { name: "8 Runners", abbr: "R6" },
    odds: { home: "3.50", draw: "-", away: "2.80" },
    markets: {
      overUnder: [
        { label: "Fav to Win", odds: "2.20" },
        { label: "Fav to Place", odds: "1.35" },
      ],
      btts: [
        { label: "Exacta (1-3)", odds: "8.50" },
        { label: "Exacta (3-1)", odds: "12.00" },
      ],
      doubleChance: [
        { label: "#1 Star Gazer", odds: "3.50" },
        { label: "#3 Cape Storm", odds: "4.00" },
        { label: "#5 Gold Rush", odds: "5.50" },
      ],
    },
  },
  {
    id: 6,
    league: "Proteas vs India - 2nd Test",
    date: "10:00",
    dateLabel: "SAT",
    home: { name: "South Africa", abbr: "SA" },
    away: { name: "India", abbr: "IND" },
    odds: { home: "2.40", draw: "3.80", away: "2.60" },
    markets: {
      overUnder: [
        { label: "SA 300+ 1st inn", odds: "2.10" },
        { label: "SA under 300", odds: "1.70" },
      ],
      btts: [
        { label: "Match drawn", odds: "3.80" },
        { label: "Result in 4 days", odds: "1.55" },
      ],
      doubleChance: [
        { label: "SA or Draw", odds: "1.50" },
        { label: "SA or India", odds: "1.25" },
        { label: "India or Draw", odds: "1.55" },
      ],
    },
  },
  {
    id: 7,
    league: "Horse Racing - Kenilworth",
    date: "15:00",
    dateLabel: "SUN",
    home: { name: "Met Stakes R1", abbr: "MET" },
    away: { name: "12 Runners", abbr: "R1" },
    odds: { home: "4.00", draw: "-", away: "3.20" },
    markets: {
      overUnder: [
        { label: "Fav to Win", odds: "2.50" },
        { label: "Fav to Place", odds: "1.25" },
      ],
      btts: [
        { label: "Trifecta Box", odds: "25.00" },
        { label: "Quinella", odds: "6.50" },
      ],
      doubleChance: [
        { label: "#2 Rainbow", odds: "4.00" },
        { label: "#6 Durban July", odds: "5.00" },
        { label: "#8 Table Bay", odds: "7.50" },
      ],
    },
  },
];
