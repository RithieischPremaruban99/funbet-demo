...
const sections = [
  { title: "1. Introduction", content: "BingoBets is committed to protecting the privacy of its users. This policy describes how we collect, use and protect your personal data, in accordance with applicable gaming regulations and data protection laws." },
  ...
  { title: "6. Your Rights", content: "You have the following rights: right of access to your data, right of rectification, right to erasure (within legal limits), right to object to processing for marketing purposes. To exercise your rights, contact us at privacy@bingobets.com." },
