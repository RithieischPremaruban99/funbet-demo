...
const sections = [
  { title: "1. Purpose", content: "These general terms and conditions govern the use of the BingoBets online gaming platform, operated under a license issued by the Gaming Commission, Ghana." },
  ...
  { title: "8. License", content: "BingoBets operates under License N° GSCB23M0865Z issued by the Gaming Commission, Ghana." },
];
