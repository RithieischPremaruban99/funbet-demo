...
const AgeVerification = () => {
  ...
  return (
    <motion.div
      ...
      style={{
        background: "radial-gradient(ellipse at 50% 40%, hsla(45,90%,52%,0.06) 0%, hsl(var(--background)) 50%, hsl(var(--background)) 100%)",
      }}
    >
      {/* Geometric pattern */}
      ...
      <div className="absolute w-48 h-48 rounded-full" style={{ background: "radial-gradient(circle, hsla(45,90%,52%,0.04) 0%, transparent 70%)" }} />
      ...
      >
        <img src={brandLogo} alt="TicTacBets" className="w-40 h-auto object-contain rounded-2xl" style={{ boxShadow: "0 0 30px hsla(45,90%,52%,0.2)" }} />
      </motion.div>
