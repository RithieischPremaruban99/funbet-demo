...
const sections = [
  { title: "1. Purpose", content: "These general terms and conditions govern the use of the Scorama online gaming platform, operated under a license issued by the competent authorities of the Democratic Republic of Congo." },
  ...
  { title: "6. Responsible Gaming", content: "Scorama is committed to promoting responsible gaming. Players can set deposit limits (daily, weekly, monthly), request temporary or permanent self-exclusion, and contact the player support service." },
  ...
  { title: "8. License", content: "Scorama operates under License N°2024/GJ/001 issued by the gaming regulatory authority of the Democratic Republic of Congo." },
];
